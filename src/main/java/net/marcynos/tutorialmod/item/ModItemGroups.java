package net.marcynos.tutorialmod.item;

import net.fabricmc.fabric.api.itemgroup.v1.FabricItemGroup;
import net.marcynos.tutorialmod.TutorialMod;
import net.marcynos.tutorialmod.block.ModBlocks;
...
public class ModItemGroups {
    ...
    public static void registerItemGroups() {
        TutorialMod.LOGGER.info("Registering ModItemGroups"+ TutorialMod.MOD_ID);
    }
}
